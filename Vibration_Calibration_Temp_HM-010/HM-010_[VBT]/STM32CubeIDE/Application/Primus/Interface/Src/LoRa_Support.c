...
/*
 TODO After Gen Code
 1. Add to LoRaMacCrypto.c //886  Resets the frame counters
...
#include "Fix_warnings.h"
	Load_fCntUp(&CryptoNvm->FCntList.FCntUp);
}

	2. Add to  LmHandler.c //471  Restore ID struct from NVM or Init from callbacks
		#include "Fix_warnings.h"
    Key_Config();
 */
