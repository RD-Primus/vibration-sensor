...
#define NFC_07A1_EH_Pin		IRQ_V_EH_Pin

#define NFC_07A1_LPD_ON		HAL_GPIO_WritePin(NFC_LPD_GPIO_Port, NFC_LPD_Pin, RESET)
//#define NFC_07A1_LPD_OFF	HAL_GPIO_WritePin(LPD_GPIO_Port, LPD_Pin, SET)
#define NFC_07A1_LPD_OFF	HAL_GPIO_WritePin(NFC_LPD_GPIO_Port, NFC_LPD_Pin, RESET)
