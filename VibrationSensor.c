...
void VibrationSensor_Process(void)
{
	...
	VibrationSensor_Output.LIS2DW12_RMS_Velocity.x = (rmsVel.x[0] * 1000);
	VibrationSensor_Output.LIS2DW12_RMS_Velocity.y = (rmsVel.y[0] * 1000);
	VibrationSensor_Output.LIS2DW12_RMS_Velocity.z = (rmsVel.z[0] * 1000);

	VibrationSensor_Output.LIS2DW12_RMS_Acceleration.x = rmsAcc.x[0];
	VibrationSensor_Output.LIS2DW12_RMS_Acceleration.y = rmsAcc.y[0];
	VibrationSensor_Output.LIS2DW12_RMS_Acceleration.z = rmsAcc.z[0];
