...
int32_t CUSTOM_NFCTAG_Init (uint32_t Instance)
{
  ...
  IO.Init         = CUSTOM_ST25DVXXKC_I2C_Init;
  IO.DeInit       = CUSTOM_ST25DVXXKC_I2C_DeInit;
  IO.IsReady      = CUSTOM_ST25DVXXKC_I2C_IsReady;
  IO.Read         = CUSTOM_ST25DVXXKC_I2C_ReadReg16;
  IO.Write        = (ST25DVxxKC_Write_Func)CUSTOM_ST25DVXXKC_I2C_WriteReg16;
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadITPulse(uint32_t Instance, ST25DVxxKC_PULSE_DURATION_E * const pITtime )
{
  UNUSED(Instance);
...
/**
  ...
  */
int32_t CUSTOM_NFCTAG_WriteITPulse( uint32_t Instance, const ST25DVxxKC_PULSE_DURATION_E ITtime )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadUID( uint32_t Instance, ST25DVxxKC_UID_t * const pUid )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pLockDsfid Pointer on a ST25DVxxKC_LOCK_STATUS used to return the DSFID lock state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadDsfidRFProtection( uint32_t Instance, ST25DVxxKC_LOCK_STATUS_E * const pLockDsfid )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pLockAfi Pointer on a ST25DVxxKC_LOCK_STATUS used to return the ASFID lock state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadAfiRFProtection( uint32_t Instance, ST25DVxxKC_LOCK_STATUS_E * const pLockAfi )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadI2CProtectZone( uint32_t Instance, ST25DVxxKC_I2C_PROT_ZONE_t * const pProtZone )
{
  UNUSED(Instance);
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param    Zone                ST25DVxxKC_PROTECTION_ZONE value coresponding to the area to protect.
  * @param    ReadWriteProtection ST25DVxxKC_PROTECTION_CONF value corresponding to the protection to be set.
  * @return   int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteI2CProtectZonex(uint32_t Instance, const ST25DVxxKC_PROTECTION_ZONE_E Zone,  const ST25DVxxKC_PROTECTION_CONF_E ReadWriteProtection )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pLockCCFile Pointer on a ST25DVxxKC_LOCK_CCFILE_t value corresponding to the lock state of the CCFile.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadLockCCFile(uint32_t Instance, ST25DVxxKC_LOCK_CCFILE_t * const pLockCCFile )
{
  UNUSED(Instance);
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param  NbBlockCCFile ST25DVxxKC_CCFILE_BLOCK value corresponding to the number of blocks to be locked.
  * @param  LockCCFile    ST25DVxxKC_LOCK_CCFILE_t value corresponding to the lock state to apply on the CCFile.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteLockCCFile(uint32_t Instance, const ST25DVxxKC_CCFILE_BLOCK_E NbBlockCCFile,  const ST25DVxxKC_LOCK_STATUS_E LockCCFile )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pLockCfg Pointer on a ST25DVxxKC_LOCK_STATUS value corresponding to the Cfg registers lock state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadLockCFG(uint32_t Instance, ST25DVxxKC_LOCK_STATUS_E * const pLockCfg )
{
  UNUSED(Instance);
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param  LockCfg ST25DVxxKC_LOCK_STATUS value corresponding to the lock state to be written.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteLockCFG(uint32_t Instance, const ST25DVxxKC_LOCK_STATUS_E LockCfg )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_PresentI2CPassword(uint32_t Instance, const ST25DVxxKC_PASSWD_t PassWord )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteI2CPassword(uint32_t Instance, const ST25DVxxKC_PASSWD_t PassWord )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  Zone        ST25DVxxKC_PROTECTION_ZONE value coresponding to the protected area.
  * @param  pRfprotZone Pointer on a ST25DVxxKC_RF_PROT_ZONE value corresponding to the area protection state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadRFZxSS(uint32_t Instance, const ST25DVxxKC_PROTECTION_ZONE_E Zone,  ST25DVxxKC_RF_PROT_ZONE_t * const pRfprotZone )
{
  UNUSED(Instance);
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param  Zone        ST25DVxxKC_PROTECTION_ZONE value corresponding to the area on which to set the RF protection.
  * @param  RfProtZone  Pointer on a ST25DVxxKC_RF_PROT_ZONE value defininf the protection to be set on the area.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteRFZxSS(uint32_t Instance, const ST25DVxxKC_PROTECTION_ZONE_E Zone,  const ST25DVxxKC_RF_PROT_ZONE_t RfProtZone )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadEndZonex(uint32_t Instance, const ST25DVxxKC_END_ZONE_E EndZone,  uint8_t * const pEndZ )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteEndZonex(uint32_t Instance, const ST25DVxxKC_END_ZONE_E EndZone,  const uint8_t EndZ )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pSizeInfo Pointer on a ST25DVxxKC_MEM_SIZE structure used to return the Memory size information.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadMemSize(uint32_t Instance, ST25DVxxKC_MEM_SIZE_t * const pSizeInfo )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadEHMode(uint32_t Instance, ST25DVxxKC_EH_MODE_STATUS_E * const pEH_mode )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadRFMngt(uint32_t Instance, ST25DVxxKC_RF_MNGT_t * const pRF_Mngt )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pRFDisable Pointer on a ST25DVxxKC_EN_STATUS value corresponding to the RF Disable status.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetRFDisable(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pRFDisable )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetRFSleep(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pRFSleep )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadMBMode(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pMB_mode )
{
  UNUSED(Instance);
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param  MB_mode ST25DVxxKC_EN_STATUS value corresponding to the Mailbox mode to be set.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_WriteMBMode(uint32_t Instance, const ST25DVxxKC_EN_STATUS_E MB_mode )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadI2CSecuritySession_Dyn(uint32_t Instance, ST25DVxxKC_I2CSSO_STATUS_E * const pSession )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pGPO_en ST25DVxxKC_EN_STATUS pointer of the GPO enable status to store
  * @retval NFCTAG enum status
  */
int32_t CUSTOM_NFCTAG_GetGPO_en_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pGPO_en )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pEH_CTRL : ST25DVxxKC_EH_CTRL pointer of the dynamic EH Ctrl configuration to store
  * @retval NFCTAG enum status
  */
int32_t CUSTOM_NFCTAG_ReadEHCtrl_Dyn(uint32_t Instance, ST25DVxxKC_EH_CTRL_t * const pEH_CTRL )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pEH_Val Pointer on a ST25DVxxKC_EN_STATUS value used to return the Energy Harvesting dynamic status.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetEHENMode_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pEH_Val )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pEHON Pointer on a ST25DVxxKC_EN_STATUS value used to return the EHON status.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetEHON_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pEHON )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pRF_Field Pointer on a ST25DVxxKC_FIELD_STATUS value used to return the field presence.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetRFField_Dyn(uint32_t Instance, ST25DVxxKC_FIELD_STATUS_E * const pRF_Field )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pVCC ST25DVxxKC_VCC_STATUS pointer of the VCC status to store
  * @retval NFCTAG enum status.
  */
int32_t CUSTOM_NFCTAG_GetVCC_Dyn(uint32_t Instance, ST25DVxxKC_VCC_STATUS_E * const pVCC )
{
  UNUSED(Instance);
...
/**
  ...
  * @retval NFCTAG enum status
  */
int32_t CUSTOM_NFCTAG_ReadRFMngt_Dyn(uint32_t Instance, ST25DVxxKC_RF_MNGT_t * const pRF_Mngt )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pRFDisable Pointer on a ST25DVxxKC_EN_STATUS value used to return the RF Disable state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetRFDisable_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pRFDisable )
{
  UNUSED(Instance);
...
/**
  ...
  * @param  pRFSleep Pointer on a ST25DVxxKC_EN_STATUS values used to return the RF Sleep state.
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetRFSleep_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pRFSleep )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_ReadMBCtrl_Dyn(uint32_t Instance, ST25DVxxKC_MB_CTRL_DYN_STATUS_t * const pCtrlStatus )
{
  UNUSED(Instance);
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t CUSTOM_NFCTAG_GetMBEN_Dyn(uint32_t Instance, ST25DVxxKC_EN_STATUS_E * const pMBEN )
{
  UNUSED(Instance);
...
int32_t NFC07A1_GetTick(void) //BMP
{
  int32_t getTick;
