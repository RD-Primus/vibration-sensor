...
/** @defgroup B_WL5M_SUBG1_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup B_WL5M_SUBG1_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup B_WL5M_SUBG1_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup B_WL5M_SUBG1_LOW_LEVEL_Private_Functions B_WL5M_SUBG1 LOW LEVEL Private Functions
  * @{
  */

/** @defgroup B_WL5M_SUBG1_BUS_Exported_Functions B_WL5M_SUBG1_BUS Exported Functions
  * @{
  */
