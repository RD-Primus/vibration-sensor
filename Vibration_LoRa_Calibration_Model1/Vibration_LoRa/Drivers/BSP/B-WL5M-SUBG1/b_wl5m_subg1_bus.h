...
#ifndef B_WL5M_SUBG1_BUS_H
#define B_WL5M_SUBG1_BUS_H
...
/** @addtogroup B_WL5M_SUBG1
  * @{
  */

/** @defgroup B_WL5M_SUBG1_BUS B_WL5M_SUBG1 BUS
  * @{
  */

/** @defgroup B_WL5M_SUBG1_BUS_Exported_Constants B_WL5M_SUBG1 BUS Exported Constants
  * @{
  */
...
#define BUS_I2C3_SDA_GPIO_PIN GPIO_PIN_1
...
/** @defgroup B_WL5M_SUBG1_BUS_Private_Types B_WL5M_SUBG1 BUS Private types
  * @{
  */
...
/** @defgroup B_WL5M_SUBG1_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup B_WL5M_SUBG1_BUS_Exported_Functions
  * @{
  */
